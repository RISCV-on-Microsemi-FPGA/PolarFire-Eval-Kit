...
proc create_new_project_label_axi { }\
{
   ...
   puts "------------PF_EVAL_KIT_ES_MiV_AXI_BaseDesign--------------------------"
   puts "-----------------------------------------------------------------------------------------------"
   puts "-----------------------------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
   ...
   puts "-----------------------------------------------------------------------------------------------"
   puts "---------------------------Creating New Project------------------------------------"
   puts "------------PF_EVAL_KIT_ES_MiV_AHB_BaseDesign------------------------"
   puts "-----------------------------------------------------------------------------------------------"
   puts "-----------------------------------------------------------------------------------------------"
}
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {PF_EVAL_KIT_ES_MiV_AHB_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_EVAL_KIT_ES_MiV_AXI_BaseDesign} \
