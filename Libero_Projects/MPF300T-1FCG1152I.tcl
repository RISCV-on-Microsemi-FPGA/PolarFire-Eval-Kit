...
append Libero_project_name_axi "_MPF300T-1FCG1152I"
append project_dir_axi "_MPF300T-1FCG1152I"
append project_folder_name_axi "_MPF300T-1FCG1152I"
...
append Libero_project_name_ahb "_MPF300T-1FCG1152I"
append project_dir_ahb "_MPF300T-1FCG1152I"
append project_folder_name_ahb "_MPF300T-1FCG1152I"
...
proc create_new_project_label_axi { }\
{
	...
	puts "--------MiV_RV32IMA_L1_AXI_BaseDesign_MPF300T_EVAL_KIT-------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "--------MiV_RV32IMA_L1_AHB_BaseDesign_MPF300T_EVAL_KIT-------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
if {"$target" == "AXI"} then {
	...
	if {[file exists $project_dir_ahb] == 1} then {
		...
		source ./import/components/MPF300T-1FCG1152I/AHB/import_component_and_constraints_mpf300_eval_kit_ahb.tcl
		save_project
		puts "-------------------------------------------------------------------------"
		puts "-------------------------------SUCCESS!----------------------------------"
		puts "-------------------------------------------------------------------------"
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_MPF300T-AHB-ProgramFile} \
		...
		export_prog_job \
			-job_file_name {BaseDesign_MPF300T-AXI-ProgramFile} \
			-export_dir {./../FlashPro_Express_Projects/Programming_Files} \
			-bitstream_file_type {TRUSTED_FACILITY} \
			-bitstream_file_components {}
		save_project
