...
This folder contains Tcl scripts that build Libero SoC (**v12.3**) design projects for the PolarFire Evaluation Kit. These scripts are executed in Libero SoC to generate the sample designs.
